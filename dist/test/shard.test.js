...
import { createShard, createChunkedShards, serializeShard, deserializeShard, replayShards, factToUpsertOp, MAX_SHARD_BYTES, } from "../core/shard.js";
    ...
    describe("createChunkedShards", () => {
        ...
        it("each chunk serializes under the byte limit", () => {
            ...
            for (const shard of shards) {
                ...
                assert.ok(serialized.byteLength + 28 <= limit, `chunk v${shard.shard_version} is ${serialized.byteLength + 28} bytes, limit is ${limit}`);
            }
        });
...
//# sourceMappingURL=shard.test.js.map