...
describe("engine", () => {
    ...
    describe("budget trimming", () => {
        it("limits facts to fit model budget", () => {
            ...
            const facts = Array.from({ length: 100 }, (_, i) => makeFact({ key: `fact:${i}`, id: `id-${i}`, tags: ["match"] }));
        ...
        it("large model can fit more facts", () => {
            const facts = Array.from({ length: 1000 }, (_, i) => makeFact({ key: `fact:${i}`, id: `id-${i}`, tags: ["match"] }));
